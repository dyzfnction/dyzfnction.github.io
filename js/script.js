...
/* ============================== */
/*   Script JS pour Responsivité   */
/* ============================== */
/* À insérer dans un <script> séparé, ou ici pour référence */
...
//       footer.style.padding = "0.2rem 0.2rem";
//     } else if (width <= 480) {
//       footer.style.flexDirection = "column";
//       footer.style.alignItems = "flex-start";
//       footer.style.padding = "0.2rem 0.4rem";
//     } else if (width <= 768) {
//       footer.style.flexDirection = "row";
//       footer.style.alignItems = "center";
//       footer.style.padding = "0.4rem 1rem";
//     } else {
//       footer.style.flexDirection = "row";
//       footer.style.alignItems = "center";
//       footer.style.padding = "0.9rem 1rem";
//     }

//     // Exemple Accueil - ajuster description
//     const accueilDescription = document.querySelector('.accueil-description');
//     if (accueilDescription) {
//       if (width <= 480) {
//         accueilDescription.style.fontSize = "0.8rem";
//       } else if (width <= 768) {
//         accueilDescription.style.fontSize = "0.9rem";
//       } else {
//         accueilDescription.style.fontSize = "1rem";
//       }
//     }
//   }
